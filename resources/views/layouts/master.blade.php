            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview menu-close">
                            <a href="#" :class="[currentPage.includes('/users') ? 'active' : '', 'nav-link']">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <router-link to="/users" :class="[currentPage.includes('/users') ? 'active' : '', 'nav-link']">
                        ...
                        <li class="nav-item">
                            <router-link to="developer" :class="[currentPage.includes('/developer') ? 'active' : '', 'nav-link']">
                        ...
                        <li class="nav-item">
                            <router-link to="profile" :class="[currentPage.includes('/profile') ? 'active' : '', 'nav-link']">
